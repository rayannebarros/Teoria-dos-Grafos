...
class Grafo:
    ...
    def procura_caminho_euleriano(self, vertex=None, way=None, edges=None):
                ...
                for i in edges_adjacents:
                    ...
                    if next[0] == vertex:
                        ...
                        if ars not in way and ars[::-1] not in way:
                            way.append(vertex + self.SEPARADOR_ARESTA + next[1])
                            result = self.procura_caminho_euleriano(next[1], way, edges)
                            if result != False:
                                return result
                            else:
                                if len(edges)==0:
                        ...
                        if len(edges_adjacents) != 1:
                            ...
                            if ars not in way and ars[::-1] not in way:
                                way.append(vertex + self.SEPARADOR_ARESTA + next[0])
                                result = self.procura_caminho_euleriano(next[0], way, edges)
                                if result != False:
                                    return result
                                else:
                                    if len(edges) == 0:
