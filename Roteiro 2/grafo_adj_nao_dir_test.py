...
class TestGrafo(unittest.TestCase):
    ...
    def test_arestas_sobre_vertice(self):
        ...
        self.assertEqual(set(self.g_p.arestas_sobre_vertice('C')), {'J-C', 'C-E', 'C-E', 'C-P', 'C-P', 'C-M', 'C-T'})
    ...
    def test_ha_ciclo(self):
        self.assertEqual(set(self.g_p.ha_ciclo()), {"C-E", "E-C"})
        self.assertEqual(set(self.g_p_sem_paralelas.ha_ciclo()), {'C-T', 'T-M', 'M-C'})
        self.assertEqual(set(self.g_c.ha_ciclo()), {'J-P', 'P-E', 'E-C', 'C-J'})
        self.assertFalse(self.g_c3.ha_ciclo())
        self.assertEqual(set(self.g_l1.ha_ciclo()), {"A-A"})
        self.assertEqual(set(self.g_l3.ha_ciclo()), {"C-C"})
        self.assertEqual(set(self.g_l4.ha_ciclo()), {"D-D"})
        self.assertEqual(set(self.g_l5.ha_ciclo()), {"C-C"})

    def test_comprimento_de_tamanho_n(self):
        self.assertTrue(self.g_p.caminho_de_comprimento_n(1))
        self.assertTrue((self.g_p_sem_paralelas.caminho_de_comprimento_n(2)))
        self.assertTrue((self.g_c.caminho_de_comprimento_n(3)))
        self.assertFalse((self.g_c3.caminho_de_comprimento_n(5)))
        self.assertFalse((self.g_l1.caminho_de_comprimento_n(6)))
        self.assertFalse((self.g_l2.caminho_de_comprimento_n(7)))
        self.assertFalse((self.g_l3.caminho_de_comprimento_n(8)))
        self.assertFalse((self.g_l4.caminho_de_comprimento_n(9)))
        self.assertFalse((self.g_l5.caminho_de_comprimento_n(10)))
